            ...
            <div class="panel-body">
                    ...
                    <div class="skills-grid" id="js-skills">
                        ...
                        <div class="skill-card {{ $skill->is_active ? 'active' : 'inactive' }}" data-id="{{ $skill->id }}">
                            ...
                            <div class="skill-actions">
                                <button class="action-btn toggle" onclick="toggleSkill({{ $skill->id }})" title="{{ $skill->is_active ? 'Deactivate' : 'Activate' }}">
                                    <i class="fas fa-{{ $skill->is_active ? 'eye-slash' : 'eye' }}"></i>
                                </button>
                                <button class="action-btn edit" onclick="editSkill({{ $skill->id }}, '{{ $skill->name }}', '{{ $skill->icon }}', {{ $skill->proficiency }})" title="Edit">
                ...
                @else
                    <div class="empty-state">
                        ...
                        <button class="btn-primary" onclick="openSkillModal('javascript')">
                            <i class="fas fa-plus"></i>
                            Add First Skill
                        </button>
                    </div>
            ...
            <div class="panel-body">
                ...
                @else
                    <div class="empty-state">
                        ...
                        <button class="btn-primary" onclick="openSkillModal('php')">
                            <i class="fas fa-plus"></i>
                            Add First Skill
                        </button>
                    </div>
